...
PlotOutputDir='/Users/harrietalexander/Dropbox/NB_130920/STD_Histograms/'
...
GSO_Quad=STD.count_Quadrants2(GSO_STD_all, 0.5, 0.5)
...
MMETSP_Quad=STD.count_Quadrants2(MMETSP_STD_all, 0.5, 0.5)
...
# MMETSPCutoffs=[]
# for c in cutoffs:
# 	GSO_Quad=STD.count_Quadrants2(GSO_STD_all, c, c)
# 	GSO_quadnums=GSO_Quad[1]
# 	GSO_total=GSO_Quad[2]
# 	GSO_quadDiv=divideList(GSO_quadnums, GSO_total)
# 	GSOCutoffs.append(GSO_quadDiv)
# 	MMETSP_Quad=STD.count_Quadrants2(MMETSP_STD_all, c, c)
# 	MMETSP_quadnums=MMETSP_Quad[1]
# 	MMETSP_total=MMETSP_Quad[2]
# 	MMETSP_quadDiv=divideList(MMETSP_quadnums, MMETSP_total)
...
# 	for x in range(4):
# 		c=colors[x]
# 		fig.plot([1,2,3,4,5], GSO_Plot[x], color=c)
# 		fig.plot([1,2,3,4,5], MMETSP_Plot[x], linestyle='dashed', color=c)
# 	fig.set_title(stitle)
# 	fig.set_xticks([1, 2, 3, 4, 5])
# 	fig.set_ylim([0, 0.8])
# 	if i==0:
...
# 
# cutoffs=np.linspace(0.25, 0.75, 10)
# GSOCutoffs=[]
# MMETSPCutoffs=[]
# for n in cutoffs:
# 	for p in cutoffs:
# 		GSO_Quad=STD.count_Quadrants2(GSO_STD_all, n, p)
# 		GSO_quadnums=GSO_Quad[1]
# 		GSO_total=GSO_Quad[2]
# 		GSO_quadDiv=divideList(GSO_quadnums, GSO_total)
# 		GSOCutoffs.append(GSO_quadDiv)
# 		MMETSP_Quad=STD.count_Quadrants2(MMETSP_STD_all, n, p)
# 		MMETSP_quadnums=MMETSP_Quad[1]
# 		MMETSP_total=MMETSP_Quad[2]
# 		MMETSP_quadDiv=divideList(MMETSP_quadnums, MMETSP_total)
# 		MMETSPCutoffs.append(MMETSP_quadDiv)
...
# for x in range(4):
# 	c=colors[x]
# 	fig.errorbar([1,2,3,4,5], GSO_MeanSTD[0][x], yerr=GSO_MeanSTD[1][x], color=c, marker='o', markersize=10, markeredgecolor=c)
# 	fig.errorbar([1,2,3,4,5], MMETSP_MeanSTD[0][x], yerr=MMETSP_MeanSTD[1][x], linestyle='dashed', color=c, marker='s', markersize=10, markeredgecolor=c)
# fig.set_xticks([1, 2, 3, 4, 5])
# fig.set_xlim([0.5,5.5])
# fig.legend(["GSO:Co-limited", "MMETSP:Co-limited", "GSO:P-limited", "MMETSP:P-limited", "GSO:Replete", "MMETSP:Replete","GSO:N-limited", "MMETSP:N-limited"])
# fig.set_ylabel('% Quadrent')
# fig.set_xlabel('Sample')
...
# 	fig.set_xticklabels( ('S1', 'S2', 'S3', 'S4', 'S5') )
