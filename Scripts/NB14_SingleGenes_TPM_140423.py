	...
	for item in Phash[ref]:
		...
		if re.search('Throt', item):	
			if any(item==s for s in Throt_GeneList['P_Genes'][0]):
			 	ax1.plot(x[:5],Throt_tpm[item][:5], ls='--', color=PUp, marker='o', mec=PUp, ms=12,linewidth=3)
			 	ax2.plot(x[5:],Throt_tpm[item][5:],ls='None',color=PUp, marker='o', mec=PUp, ms=12,linewidth=3)
			elif any(item==s for s in Throt_GeneList['P_Genes'][1]):
			 	ax1.plot(x[:5],Throt_tpm[item][:5],ls='--', color=PDn, marker='o', mec=PDn, ms=12,linewidth=3)
			 	ax2.plot(x[5:],Throt_tpm[item][5:],ls='None',color=PDn, marker='o', mec=PDn, ms=12,linewidth=3)
			elif any(item==s for s in Throt_GeneList['N_Genes'][0]):
			 	ax1.plot(x[:5],Throt_tpm[item][:5], ls='--',color=NUp, marker='o', mec=NUp, ms=12,linewidth=3)
			 	ax2.plot(x[5:],Throt_tpm[item][5:],ls='None', color=NUp, marker='o', mec=NUp, ms=12,linewidth=3)
			elif any(item==s for s in Throt_GeneList['N_Genes'][1]):
			 	ax1.plot(x[:5],Throt_tpm[item][:5], ls='--', color=NDn, marker='o', mec=NDn, ms=12,linewidth=3)
			 	ax2.plot(x[5:],Throt_tpm[item][5:],ls='None',color=NDn, marker='o', mec=NDn, ms=12,linewidth=3)
			else:
				ax1.plot(x[:5],Throt_tpm[item][:5], ls='--',color=NRG, marker='o',mec=NRG, ms=12,linewidth=3)
			 	ax2.plot(x[5:],Throt_tpm[item][5:],ls='None',color=NRG, marker='o',mec=NRG, ms=12,linewidth=3)
			 	

		elif re.search('Skcos', item):
			if any(item==s for s in Skcos_GeneList['P_Genes'][0]):
			 	ax1.plot(x[:5],Skcos_tpm[item][:5], ls='-', color=PUp, marker='s', mec=PUp, ms=12,linewidth=3)
			 	ax2.plot(x[5:],Skcos_tpm[item][5:],ls='None',color=PUp, marker='s', mec=PUp, ms=12,linewidth=3)
			elif any(item==s for s in Skcos_GeneList['P_Genes'][1]):
			 	ax1.plot(x[:5],Skcos_tpm[item][:5],ls='-', color=PDn, marker='s', mec=PDn, ms=12,linewidth=3)
			 	ax2.plot(x[5:],Skcos_tpm[item][5:],ls='None',color=PDn, marker='s', mec=PDn, ms=12,linewidth=3)
			elif any(item==s for s in Skcos_GeneList['N_Genes'][0]):
			 	ax1.plot(x[:5],Skcos_tpm[item][:5], ls='-',color=NUp, marker='s', mec=NUp, ms=12,linewidth=3)
			 	ax2.plot(x[5:],Skcos_tpm[item][5:],ls='None', color=NUp, marker='s', mec=NUp, ms=12,linewidth=3)
			elif any(item==s for s in Skcos_GeneList['N_Genes'][1]):
			 	ax1.plot(x[:5],Skcos_tpm[item][:5], ls='-', color=NDn, marker='s', mec=NDn, ms=12,linewidth=3)
			 	ax2.plot(x[5:],Skcos_tpm[item][5:],ls='None',color=NDn, marker='s', mec=NDn, ms=12,linewidth=3)
			else:
				ax1.plot(x[:5],Skcos_tpm[item][:5], ls='-',color=NRG, marker='o',mec=NRG, ms=12,linewidth=3)
			 	ax2.plot(x[5:],Skcos_tpm[item][5:],ls='None',color=NRG, marker='o',mec=NRG, ms=12,linewidth=3)
